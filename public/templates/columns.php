      ...
      */
      ...
      include('widgets.php');
        ...
        if ($columnWidth == 0 || $columnWidth === "") {
          ...
          //$columnWidthPercent = ($columnWidth/1268)*100;
          $colHeight = '10';
      $columnStyles = "width:".$columnWidthPercent.$columnWidthUnit."; min-height:$rowHeight"."px; background:$columnBgColor; background-color:$columnBgColor; $columnMarginStyle  $columnPaddingStyle  $columnCSS";
