<?php if ( ! defined( 'ABSPATH' ) ) exit; 
  ...
  $DotColor = PShexToRGB($psBgColor, -70);

  $psScripts = "<script type='text/javascript' src='".ULPB_PLUGIN_URL."/public/scripts/owl-carousel/owl.carousel.js'></script> <link rel='stylesheet' type='text/css' href='".ULPB_PLUGIN_URL."/public/scripts/owl-carousel/owl.carousel.css'>
  ...
  echo $psScripts.'<div id="PbPostSlider-'.$PSrandID.'" class="owl-carousel" style="background:'.''.'; text-align:'.$psTextAlignment.'; width:95%; margin: 0 auto; padding:0.1% 0 2% 0;">';
