...
function ulpb_register_feed_post_type() {
	...
	$labels = array(
		...
		'singular_name'       => __( 'Landing Page', 'pbp-ps-cpt' ),
		'all_items'       	  => __( 'All Landing Pages', 'pbp-ps-cpt' ),
		'add_new'             => _x( 'Add New Page', 'pbp-ps-cpt', 'pbp-ps-cpt' ),
		'add_new_item'        => __( 'Add New Page', 'pbp-ps-cpt' ),
		'edit_item'           => __( 'Edit Page', 'pbp-ps-cpt' ),
		'new_item'            => __( 'New Landing Page', 'pbp-ps-cpt' ),
		...
		'menu_name'           => __( 'Landing Page Builder', 'pbp-ps-cpt' ),
	);
