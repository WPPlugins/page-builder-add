...
function plugOPB_check_installation_date() {
    ...
    $nobug = "";
    $nobug = get_option('plugOPB_no_bugs');
...
function plugOPB_display_admin_notice() {
    ...
    echo '<p>' . __( 'If you enjoy using <strong> Page Builder Plugin</strong> please leave us a <span class="dashicons dashicons-star-filled"></span><span class="dashicons dashicons-star-filled"></span><span class="dashicons dashicons-star-filled"></span><span class="dashicons dashicons-star-filled"></span><span class="dashicons dashicons-star-filled"></span> review. Reviews like yours help us improve the plugin.', 'page-builder-add' ) . '</p>';
...
function plugOPB_set_no_bug() {
    ...
    if ( 1 == $nobug ) {
        ...
        add_option( 'plugOPB_no_bugs', TRUE );
