...
$('.wp-picker-container').css('margin-left','24%');
  ...
  $('body').append('<div id="ulpb_row_controls"> <p><div id="newRowClose" class="btn-red btn"><span class="dashicons dashicons-no-alt"></span></div></p> <p><div id="newRowSave" class="btn"><span class="dashicons dashicons-yes"></span></div></p> </div> </div></div>');
